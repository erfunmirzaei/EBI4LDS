...
def Covariance_Estimation_tau(data_points, n, delta, configs):
    """ 
    Estimates the covariance using the bounds in the paper for different values of block sizes(tau)
    Args:
        data_points: np.array, shape (n, n_repits)
    ...
    Returns:
        ...
        Pinelis_emp_bound_biased_cov_est: np.array, shape (n_0, n_repits), empirical Pinelis bound for the biased covariance estimation
        Pinelis_emp_bound_unbiased_cov_est: np.array, shape (n_0, n_repits), empirical Pinelis bound for the unbiased covariance estimation
        M_bound: np.array, shape (n_0, n_repits), our bound for the covariance estimation
        M_emp_bound_biased_cov_est: np.array, shape (n_0, n_repits), our empirical bound for the biased covariance estimation
        M_emp_bound_unbiased_cov_est: np.array, shape (n_0, n_repits), our empirical bound for the unbiased covariance estimation
        taus: list, block sizes
    """
...
def Cov_Est_N(data_points, Ns, delta,  configs):
    """
    Estimates the covariance using the bounds in the paper for different values of sample sizes(N)
    Args:
        data_points: np.array, shape (n, n_repits)
    ...
    Returns:
        ...
        M_emp_bound_biased_cov_est: np.array, shape (n_0, n_repits), our empirical bound for the biased covariance estimation
        M_emp_bound_unbiased_cov_est: np.array, shape (n_0, n_repits), our empirical bound for the unbiased covariance estimation
        True_value: np.array, shape (n_0, n_repits), true value of the covariance
    """
